...
//Registra a classe como um componente que participa
//do sistema de injeçãao de dependencia automatizado
@Service
public class ClientService {

	// dependencia com ClientRepository
	@Autowired // injeta uma instancia gerenciada pelo spring
